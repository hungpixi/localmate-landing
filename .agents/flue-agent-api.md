...
Last updated May 30, 2026 [ View as Markdown](https://flueframework.com/docs/api/agent-api/index.md) 
...
| sandbox       | false \| SandboxFactory   | BashFactory                                                                                                                                                             | Sandbox factory used to construct the initialized environment. See [Sandboxes](https://flueframework.com/docs/guide/sandboxes/). |
| persist       | SessionStore              | Conversation-state store used by initialized sessions. See [Data Persistence API](https://flueframework.com/docs/api/data-persistence-api/).                            |                                                                                                                                  |
